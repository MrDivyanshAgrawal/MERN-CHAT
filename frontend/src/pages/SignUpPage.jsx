        ...
        <div className="flex flex-col justify-center items-center px-6 sm:px-12 py-12">
          ...
          >
            <div className="text-center mb-8">
              <h2 className={`text-2xl font-bold ${textColor}`}>Create Account</h2>
              <p className={subTextColor}>Get started with your free account</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="form-control">
                <label className="label">
                  <span className={`label-text font-medium ${textColor}`}>Full Name</span>
                </label>
                <div className="relative">
                  <Users className={`absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 ${placeholderColor}`} />
                  <input
                    type="text"
            ...
            <div className={`text-center mt-6 ${textColor}`}>
              <p>
                ...
                <Link className="font-semibold text-pink-300 hover:text-pink-200 transition" to="/login">
                  Sign in
                </Link>
              </p>
            </div>
